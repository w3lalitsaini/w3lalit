...
const projects = [
    ...
    },
    {
        ...
        link: "https://w3lalitsaini.github.io/Furniture-web/",
    },
    {
        ...
        link: "https://w3lalitsaini.github.io/Rajasthan-Tourism/",
    },
    {
        title: "Univ Result",
    ...
    },
    {
        ...
        link: "https://w3lalitsaini.github.io/Studio/",
    },
    {
        ...
        tags: ["HTML", "CSS", "JS"],
        link: "https://w3lalitsaini.github.io/portfolio/",
    },
    {
        ...
        link: "https://w3lalitsaini.github.io/Rajasthan/",
    },
    {
        title: "Info Blog",
        ...
        <section id="work" className="max-w-6xl mx-auto px-4 md:px-6 pb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {visibleProjects.map((project, i) => (
                    <div
                        key={i}
                        className="group bg-dark/50 rounded-xl overflow-hidden border border-grayMid/30 
            hover:border-orange hover:border-opacity-60 hover:scale-[1.02] transition-all duration-300 cursor-pointer"
